...
const NVRAM_LENS_PARA_STRUCT DW9714AF_S5K4H5_LENS_PARA_DEFAULT_VALUE = 
{1, // Version
...
UINT32 DW9714AF_S5K4H5_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &DW9714AF_S5K4H5_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pDW9714AF_S5K4H5_getDefaultData = DW9714AF_S5K4H5_getDefaultData;
